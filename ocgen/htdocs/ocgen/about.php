        ...
        <p>If you have any questions or feedback regarding the OpenClash Config Generator, please feel free to contact me.</p>
				 ...
				 <div class="server">
						...
						<div class="text-center">
							<form method="post">
								<button type="submit" class="btn btn-danger" name="delete-ocgen"><i class="fa fa-trash-o" aria-hidden="true"></i> Delete OcGen</button><p>
							</form>
<?php
...
// fungsi untuk menghapus OcGen
if(isset($_POST['delete-ocgen'])){ //jika tombol delete ditekan
	deleteOcgen();	
}
// end of fungsi menghapus OcGen
?>
