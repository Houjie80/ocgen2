...
if(isset($_POST['save'])) {
    ...
    $savePath = "/etc/openclash/config/$configName.yaml";
    file_put_contents($savePath, $openClashConfig);

    // Tampilkan pesan sukses
    echo '<div class="alert alert-success">Konfigurasi berhasil disimpan di: <b> <a href="/tinyfm/index.php?p=etc%2Fopenclash%2Fconfig">' . $savePath . ' </a></p></b>Silahkan switch confignya di dashboard <a href="/cgi-bin/luci/admin/services/openclash/config">Openclash</a></div>';      
}
?>
...
<label for="yaml_name">YAML Openclash Config <a href='/tinyfm/index.php?p=etc%2Fopenclash%2Fconfig'>(check here)</a> :</label>
				  <fieldset id="servers">
				      <div class="server">
