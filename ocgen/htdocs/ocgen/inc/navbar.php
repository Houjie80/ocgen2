...
<i class="fa fa-circle-o-notch fa-spin fa-1x fa-fw"></i>
    <a class="navbar-brand" style="font-family:courier" href="#">  Openclash Config Generator</a>
    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
        <ul class="navbar-nav mr-auto">
			...
			<li class="nav-item <?php if ($url === 'netdata.php') echo 'active'; ?>">
                <a class="nav-link" href="netdata.php"><i class="fa fa-bar-chart"></i> NetData</a>
            </li>
			<li class="nav-item <?php if ($url === 'reboot.php') echo 'active'; ?>">
                <a class="nav-link" href="reboot.php"><i class="fa fa-refresh"></i> Restart</a>
            </li>
